...
public class AvatarResponse {
    ...
    public static AvatarResponse from(Avatar avatar) {
        ...
        return AvatarResponse.builder()
                ...
                .assetKey(avatar.getSnapshotAssetKey())
                .assetUrl(avatar.getSnapshotAssetUrl())
                .assetWidth(avatar.getSnapshotAssetWidth())
                .assetHeight(avatar.getSnapshotAssetHeight())
                .posX(avatar.getPosX())
                .posY(avatar.getPosY())
